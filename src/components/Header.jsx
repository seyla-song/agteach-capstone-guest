...
//    const { profileImage } = useProfileImage(); // Get profile image from context
//   const {
//     data: guestData,
...
import { useSelector } from "react-redux";
import { useGetUserInfoQuery } from "../services/api/userApi";
import { useProfileImage } from '../components/GuestProfile/ProfileImageContext'; // Adjust import path
          ...
          <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
            ...
            >
              {HEADER_MENU_MOBILE.map((item) => (
                <MenuItem key={item.page} onClick={() => setAnchorElNav(null)}>
